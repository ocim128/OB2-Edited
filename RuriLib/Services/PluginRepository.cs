...
public class PluginRepository
{
    ...
    private static IEnumerable<Assembly> GetReferences(IEnumerable<Assembly> assemblies)
    ...
    private Assembly ResolveHandler(object sender, ResolveEventArgs args)
    {
        ...
        {
            assy = SourceArray.SelectMany(g => Directory.EnumerateFiles(dir, g)).FirstOrDefault(f =>
            {
