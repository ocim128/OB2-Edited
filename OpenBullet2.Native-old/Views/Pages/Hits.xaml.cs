...
namespace OpenBullet2.Native.Views.Pages
{
    ...
    public partial class Hits : Page
    {
        ...
        {
            if (Alert.Confirm("Are you REALLY sure?", "This will delete ALL your hits, not just the ones you filtered. Are you sure you want to do this?", nameof(obSettingsService.Settings.GeneralSettings.PerformConfirmationOnDestructiveActions)))
            {
                try
                {
                    await vm.PurgeAsync();
