...
/// </remarks>
public class ProxyClientHandler(ProxyClient proxyClient) : HttpMessageHandler, IDisposable
{
    ...
    /// </summary>
    public ProxyClient ProxyClient { get; } = proxyClient ?? throw new ArgumentNullException(nameof(proxyClient));
