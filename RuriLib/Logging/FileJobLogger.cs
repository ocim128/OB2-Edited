...
{
    private readonly RuriLibSettingsService _settings;
    ...
    {
        if (!_settings.RuriLibSettings.GeneralSettings.LogJobActivityToFile)
        {
            return;
        }

        var fileName = Path.Combine(_baseFolder, $"job{jobId}.log");
