...
using AppBrush = OpenBullet2.Native.Helpers.Brush;
using System;
using System.IO;
using System.Linq;
...
namespace OpenBullet2.Native.Services
{
    public class ThemeService : IThemeService
    {
        ...
        public ThemeService(OpenBulletSettingsService openBulletSettingsService)
        {
        ...
        public void ApplyAccessibilitySettings()
        {
            ...
            var accessibility = openBulletSettingsService.Settings.AccessibilitySettings ?? new AccessibilitySettings();
