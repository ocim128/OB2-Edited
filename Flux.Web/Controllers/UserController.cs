...
public class UserController : ApiController
{
    ...
    /// <summary></summary>
    public UserController(FluxSettingsService fluxSettingsService,
        ...
        [FromServices] IValidator<UserLoginDto> validator)
    {
        ...
        // Admin user
        if (string.Equals(_fluxSettingsService.Settings.SecuritySettings.AdminUsername, dto.Username,
    ...
    {
        var passwordRequired = _fluxSettingsService.Settings.SecuritySettings.RequireAdminLogin;
        var passwordHash = _fluxSettingsService.Settings.SecuritySettings.AdminPasswordHash;
    ...
    private async Task<LoggedInUserDto> LoginGuestUser(UserLoginDto dto)
    {
        ...
        var lifetimeHours = Math.Clamp(_fluxSettingsService.Settings.SecuritySettings.GuestSessionLifetimeHours, 0, 9999);
