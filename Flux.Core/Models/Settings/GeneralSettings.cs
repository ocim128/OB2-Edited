...
public class GeneralSettings
{
    ...
    /// <summary>
    /// The interval at which changes to the config are automatically saved (in seconds).
    /// </summary>
    public int AutoSaveInterval { get; set; } = 30;

    /// <summary>
    /// Whether to ask for confirmation when performing destructive actions.
    /// </summary>
    public bool PerformConfirmationOnDestructiveActions { get; set; } = true;
