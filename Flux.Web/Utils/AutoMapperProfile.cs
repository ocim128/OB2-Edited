...
internal class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<FluxSettings, FluxSettingsDto>().ReverseMap();
        CreateMap<FluxSettings, SafeFluxSettingsDto>();
