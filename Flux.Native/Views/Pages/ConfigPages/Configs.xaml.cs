...
namespace Flux.Native.Views.Pages.Configs
{
    ...
    public partial class Configs : Page, IUpdatablePage
    {
        ...
        private void EditConfig()
        {
            ...
            if (fluxSettingsService.Settings.GeneralSettings.WarnConfigNotSaved
                ...
                && !Alert.Confirm("Config not saved", $"The currently selected config ({configService.SelectedConfig.Metadata.Name}) has unsaved changes," +
                    $" are you sure you want to edit another config?", nameof(fluxSettingsService.Settings.GeneralSettings.WarnConfigNotSaved)))
                return;
